...
const joiQueries = {
  ...
  withCities: Joi.bool().optional().default(false),
}
const joiParams = {
  withCities: Joi.bool().optional().default(false),
}
...
module.exports = ({ models }) => {
  const h = handler('Province', 'provinceId', { models })

  const countInclude = {
    query:
      '(SELECT COUNT(*) FROM "cities" WHERE "cities"."province_id" = "Province"."id")',
    attribute: 'citiesCount',
  }
